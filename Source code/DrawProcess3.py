...
class ft_net(nn.Module):
    ...
    def __init__(self):
        ...
        model_ft = models.resnet50(pretrained=True)  # 使用resnet50
        self.model = model_ft
...
model.eval()
img = cv2.imread('D:/Project/PycharmProjects/COVID19ResNetProram/data/test/COVID-19/137covid_patient76_SR_2_IM00046.png')
