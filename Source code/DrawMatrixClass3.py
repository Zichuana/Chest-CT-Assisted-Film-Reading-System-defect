...
if __name__ == '__main__':
    ...
    data_path = os.path.abspath(os.path.join(os.getcwd(), "D:/Project/PycharmProjects/COVID19ResNetProram\data"))
    ...
    model_weight_path = './NET50/ResNet50_64_3.pth'
    assert os.path.exists(model_weight_path), "cannot find {} file".format(model_weight_path)
    net.load_state_dict(torch.load(model_weight_path, map_location=device))
    net.to(device)

    # read class_indict
    json_label_path = './class3_indices.json'
